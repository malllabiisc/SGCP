...
STANFORD_CORENLP = 'src/evaluation/apps/stanford-corenlp-full-2018-10-05'
METEOR_JAR = 'src/evaluation/apps/meteor-1.5.jar'
METEOR_DATA = 'src/evaluation/data/paraphrase-en.gz'
